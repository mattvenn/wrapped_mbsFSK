...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/src/wrapped_mbsFSK.v \
    $::env(DESIGN_DIR)/src/LFSRmod.v \
    $::env(DESIGN_DIR)/src/mbsFSK.v \
    $::env(DESIGN_DIR)/src/sampleClockGen.v \
    $::env(DESIGN_DIR)/src/SymbLUT.v"
